...
//        your Array is useThisLine
      ...
      //   useThisLine arrayini kullan
        ...
        List<Integer> tekilSayilar= new ArrayList<>();

        for (int i = 0; i < useThisArray.length; i++) {
            if(!tekilSayilar.contains(useThisArray[i])) {
                tekilSayilar.add(useThisArray[i]);
            }
        }

        System.out.println(tekilSayilar);
        System.out.println("Adet : "+tekilSayilar.size());
